...
public class PersistenciaAccesoImp implements Serializable {
	...
	public static boolean compruebaUsuario(String usuario, String password) throws IOException {
	...
	public static void insertaUsuario(String usuario, String password) throws IOException {
		System.out.println("Adding usuarios autorizados ...");
