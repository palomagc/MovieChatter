...
public interface ItfUsoRecursoUsuario extends ItfUsoRecursoSimple {
	...
	/**
	 * Crea un nuevo usuario solo con nombre, sexo y edad (los demás campos vacios) y lo guarda en
	 * la base de datos
	 * 
	 * @param nombre
	 * @param sexo
	 ...
	 */
	public Usuario crearUsuario(String nombre, String sexo, String edad) throws Exception;
	...
	public Usuario crearUsuario(String nombre, String sexo, String edad,
			...
			ArrayList<String> peliculasOdiadas, Valoracion peliculaActual) throws Exception;
	 ...
	 */
	public boolean modificarUsuario(String nombre, Usuario usuarioNuevo) throws Exception;
	 ...
	 */
	public boolean nuevaValoracion(String nombreUsuario, Valoracion valoracion) throws Exception;
	 ...
	 */
	public boolean nuevoGeneroPreferido(String nombreUsuario, String genero) throws Exception;
	 ...
	 * @return true si lo ha añadido, false en caso contrario
	 */
	public boolean nuevoActorPreferido(String nombreUsuario, String actor) throws Exception;
	 ...
	 * @return true si lo ha añadido, false en caso contrario
	 */
	public boolean nuevoActorOdiado(String nombreUsuario, String actor) throws Exception;
	 ...
	 * @return true si lo ha añadido, false en caso contrario
	 */
	public boolean nuevaPeliculaOdiada(String nombreUsuario, String pelicula) throws Exception;
