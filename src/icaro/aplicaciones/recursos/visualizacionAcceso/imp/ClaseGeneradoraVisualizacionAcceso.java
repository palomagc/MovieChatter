...
public class ClaseGeneradoraVisualizacionAcceso extends ImplRecursoSimple implements
		ItfUsoVisualizadorAcceso {
	...
	public void mostrarMensajeInformacion(String titulo, String mensaje) {
		 ...
		 * .obtenerInterfaz(NombresPredefinidos.ITF_USO+NombresPredefinidos
		 * .NOMBRE_AGENTE_APLICACION+"Acceso"); itfUsoAgente.aceptaEvento(new
