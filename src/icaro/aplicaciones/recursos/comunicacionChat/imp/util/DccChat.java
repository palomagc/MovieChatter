...
public class DccChat {
	...
	/**
	 * This constructor is used when we are accepting a DCC CHAT request from somebody. It attempts
	 * to connect to the client that issued the request.
	 */
	...
	/**
	 * This constructor is used after we have issued a DCC CHAT request to somebody. If the client
	 * accepts the chat request, then the socket we obtain is passed to this constructor.
	 */
	...
	/**
	 * Reads the next line of text from the client at the other end of our DCC Chat connection. This
	 * method blocks until something can be returned. If the connection has closed, null is
	 * returned.
	 *
	 * @return The next line of text from the client. Returns null if the connection has closed.
	 */
