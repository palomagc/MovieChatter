...
public class IdentServer extends Thread {
	 ...
	 * recommended that you use the startIdentServer method in the PircBot class.
	 * <p>
	 * The ident server will wait for up to 60 seconds before shutting down. Otherwise, it will shut
	 * down as soon as it has responded to an ident request.
	 *
	 * @param bot
