...
public interface ItfUsoComunicacionTMDB extends ItfUsoRecursoSimple {
	...
	List<Movie> getMoviesByGenre(Integer genre, String sort, String language, int page)
			throws Exception;

	List<Movie> getMoviesByPerson(Integer person, String sort, String language, int page)
			throws Exception;

	List<Movie> getMoviesByYear(String year, String sort, String language, int page)
			throws Exception;
	...
	List<TV> discoverTVs(Date after, Date before, String sort, Float minAverage, Integer minCount,
			List<Integer> genres, String year, String language, int page) throws Exception;
}
