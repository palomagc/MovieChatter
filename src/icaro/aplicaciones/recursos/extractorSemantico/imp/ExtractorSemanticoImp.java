 ...
 *         un conjunto de anotaciones que seran interpretadas semanticamente ej citas . El
 *         funcionamiento se basa en un procesador generado por GATE
 */
public class ExtractorSemanticoImp {
	...
	private HashSet<String> tiposAnotacionesRelevantes;
	...
	public ExtractorSemanticoImp(String rutaProcesador) throws PersistenceException {
		...
		if (!ficheroProcesador.exists()) {
			throw new PersistenceException("El fichero especificado en la ruta : " + rutaProcesador
					+ " No existe ");
	...
	public HashSet<Annotation> extraerAnotaciones(HashSet<String> annotTypesRequired,
			String textoUsuario) {
		Document doc = null;
		try {
