...
public class Vocabulario {
	...
	static {
		...
		Generos.put("GeneroCienciaFiccion", new Genero("Science Fiction", "ciencia ficci�n"));
	...
	public static final String SaludoInicial1 = "Hola, yo soy " + Constantes.SYSTEM_NAME
			+ ", tu recomendador de pel�culas";
	public static final String[] SaludoInicial2 = { "Hola", "Qu� tal", "Buenas", "Que hay" };

	// FRASES DE NUESTRO SISTEMA
	public static final String[] Despedida = { "Adi�s.", "Hasta la pr�xima.", "Nos vemos.",
			"Que te vaya bien.", "Ha sido un placer.", "Cuando quieras repetimos." };
	public static final String[] Disfruta = { "Que la disfrutes.", "Ya me contaras qu� tal.",
			"Que te guste.", "Ojal� te guste.", "A por las palomitas." };
	public static final String InfoFuncionalidad = "Soy un cin�filo, y me encantar�a ayudarte a encontrar pel�culas.";
	...
	public static final String[] Params = { "Podr�as introducir un a�o.",
			"Puedes a�adir un actor a tu filtrado.", "Podr�as a�adir otro g�nero a la b�squeda.",
			"Puedes introducir otro g�nero, actor o a�o como filtro" };
	...
	public static final String PeticionInfoPeli = "�Podr�a recomendarte alguna pel�cula?";
	public static final String[] Recomienda = { "podr�as ver", "te sugiero", "te propongo" };
	public static final String EligeGenero = "�De que g�nero te apetece ver la pel�cula?";
	// TODO mejorar la frase
	public static final String LimpiarBusqueda = "La consulta con los par�metros dados no ha obtenido ning�n resultado."
			+ " Se limpian los par�metros de b�squeda.";
