...
public class InfoCita implements Serializable {
	...
	public boolean estaOPDefinido() {
		return (this.operacion != InfoCita.OPERACION_INDEFINIDA);
	}
	...
	public boolean estaPARAMDefinido() {
		return ((this.fecha != null) || (this.fechaNueva != null) || (this.hora != null)
				|| (this.horaNueva != null) || (this.motivo != Utilidades.int_INDEFINIDO));
	}
	...
	public boolean estaPARAMIndefinido() {
		if (this.operacion == InfoCita.OPERACION_CREAR)
			return ((this.fecha == null) && (this.hora == null) && (this.motivo == Utilidades.int_INDEFINIDO));
		else if (this.operacion == InfoCita.OPERACION_MODIFICAR)
			return ((this.fecha == null) && (this.fechaNueva == null) && (this.hora == null)
					&& (this.horaNueva == null) && (this.motivo == Utilidades.int_INDEFINIDO));
		else
			return false;
   ...
   */
	...
	/**
	 * M�todo que devuelve true si los par�metros de la cita pasada como par�metro son iguales
	 * a los de la cita actual y false e.o.c.
	 * 
	 * @param motivo
	 * @return boolean
	 */
