 ...
 * </p>
 * <p>
 * Description: Clase que contiene una Fecha y una Hora
 * </p>
 * <p>
...
public class FechaHora implements Comparable<Object>, Cloneable, java.io.Serializable {
	...
	/**
	 * M�todo que intenta completar una FechaHora primero con la lista de FechaHora y luego
	 * mediante sentido com�n
	 * 
	 * @param listaSugerencias
	 */
	public void completar(Vector<FechaHora> listaSugerencias) {
		Vector<Fecha> listaFechas = extraerListaFechas(listaSugerencias);
		Vector<Hora> listaHoras = extraerListaHoras(listaSugerencias);
		if (this.fecha == null)
	...
	/**
	 * M�todo que devuelve una lista de Fecha extrayendo las fechas de la lista de FechaHora
	 * pasada como par�metro
	 * 
	 * @param listaFechaHora
	 * @return Lista de Fecha
	 */
	private Vector<Fecha> extraerListaFechas(Vector<FechaHora> listaFechaHora) {
		Vector<Fecha> resultado = new Vector<Fecha>();
		for (int i = 0; i < listaFechaHora.size(); i++) {
			resultado.add(listaFechaHora.elementAt(i).getFecha());
		}
		return resultado;
	}
	 ...
	 * @return Lista de Fecha
	 */
	private Vector<Hora> extraerListaHoras(Vector<FechaHora> listaFechaHora) {
		Vector<Hora> resultado = new Vector<Hora>();
		for (int i = 0; i < listaFechaHora.size(); i++) {
			resultado.add(listaFechaHora.elementAt(i).getHora());
		}
		return resultado;
	}
}