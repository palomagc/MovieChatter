...
public class InfoPersonaqDaCitas extends InfoUsuarioqPideCita {
	...
	public String cargoToString(int cargo) {
		...
		case CARGO_PRESIDENTE:
			return "Presidente";
		case CARGO_CONSEJERO_DELEGADO:
			return "Consejero delegado";
		case CARGO_DIRECTOR_GENERAL:
			return "Director general";
		case CARGO_DIRECTOR:
			return "Director";
		case CARGO_GERENTE:
			return "Gerente";
		case CARGO_JEFE_DIVISION:
			return "Jefe de divisi�n";
		default:
			return "";
		}
	...
	public int cargoToInt(String cargo) {
		...
		if (cargo.equals("consejero delegado"))
			this.cargo = InfoPersonaqDaCitas.CARGO_CONSEJERO_DELEGADO;
		else if (cargo.equals("director general"))
			this.cargo = InfoPersonaqDaCitas.CARGO_DIRECTOR_GENERAL;
		else if (cargo.equals("director"))
			this.cargo = InfoPersonaqDaCitas.CARGO_DIRECTOR;
		else if (cargo.equals("subdirector"))
			this.cargo = InfoPersonaqDaCitas.CARGO_SUBDIRECTOR;
		else if (cargo.equals("gerente"))
			this.cargo = InfoPersonaqDaCitas.CARGO_GERENTE;
		else if (cargo.equals("jefe de division"))
			this.cargo = InfoPersonaqDaCitas.CARGO_JEFE_DIVISION;
		else if (cargo.equals("presidente"))
			this.cargo = InfoPersonaqDaCitas.CARGO_PRESIDENTE;
		return this.cargo;
	}
