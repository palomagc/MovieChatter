		...
		if (args.length == 0) {
			...
			try {
				...
				if ((ItfGestIniciador != null) && (ItfUsoIniciador != null)) {
					...
					// EventoRecAgte("crearOrganizacion",descOrganizacionaCrear, "main", "iniciador"
					// ));
					// args[0] contiene el identificador del fichero que contiene la definicion de
					// la organizacion a crear
					// ItfUsoIniciador.aceptaEvento( new EventoRecAgte("crearOrganizacion",args[0],
					// "main", "iniciador" ));
				}
