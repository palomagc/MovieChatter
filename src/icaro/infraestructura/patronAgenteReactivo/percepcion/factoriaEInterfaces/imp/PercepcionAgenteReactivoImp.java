...
public class PercepcionAgenteReactivoImp extends PercepcionAbstracto {
	...
	public PercepcionAgenteReactivoImp(int CapacidadBuzon, ProcesadorItemsPercepReactivo prItems,
	...
	public void SetParametrosPercepcionAgenteReactivoImp(
			LinkedBlockingDeque<Object> colaEvtosyMsgs, ProcesadorItemsPercepReactivo prItems,
			AgenteReactivoAbstracto agente) {
	...
	public synchronized void aceptaEvento(EventoSimple evento) throws RemoteException {
		trazas.aceptaNuevaTraza(new InfoTraza(this.agente.getIdentAgente(),
				"Percepcion: Ha llegado un nuevo evento desde " + evento.getOrigen(),
	...
	public synchronized void aceptaMensaje(MensajeSimple mensaje) throws RemoteException {
		trazas.aceptaNuevaTraza(new InfoTraza(this.agente.getIdentAgente(),
				"Percepcion: Ha llegado un nuevo mensaje desde " + mensaje.getEmisor(),
				InfoTraza.NivelTraza.debug));
		...
		public void run() {
			while (!termina) {
				...
				try {
					...
					java.util.logging.Logger.getLogger(PercepcionAgenteReactivoImp.class.getName())
