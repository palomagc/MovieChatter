...
public class GestorAccionesAgteReactivoImp extends GestorAccionesAbstr implements ItfGestorAcciones {
	...
	public void inicializarInfoAccionesAgteReactivo(String identAgte,
			ItfProductorPercepcion itfEvtosInternos, ItfControlAgteReactivo itfControl) {
		try {
			identPropietario = identAgte;
			envioInputs = itfEvtosInternos;
			itfControlAgte = itfControl;
		} catch (Exception ex) {
			java.util.logging.Logger.getLogger(GestorAccionesAgteReactivoImp.class.getName()).log(
	...
	public AccionesSemanticasAgenteReactivo getInstanceASagteReactivo(Class accionClass) {
		...
		try {
			...
			accionesSemAgteReactivo.inicializarAcciones(this.identPropietario, itfControlAgte,
					envioInputs);
	...
	public void ejecutar(Object... paramsEjecucion) throws Exception {
		...
		if (superclase.equals(accionSincSimpleName)
			...
			this.trazas.trazar(this.getClass().getSimpleName(),
					"Error en  la ejecucion de la accion: " + claseAccionEjecutar.getSimpleName()
	...
	@Override
	public void ejecutarAccion(Class claseAccionEjecutar, Object... paramsEjecucion)
			throws Exception {
		// Class claseAccionEjecutar = (Class)paramsEjecucion[0];
		// Extraccion de parametros y verificacion de la clase
	...
	@Override
	public synchronized void ejecutarMetodo(Class claseAccionEjecutar, String identMetodo,
		...
		try {
			...
			System.out.println("ERROR (NO EXISTE) al invocar el metodo: " + identMetodo
					+ " en la clase: " + accionesSemAgteReactivo.getClass().getName());
			...
			System.out.println("ERROR en la ejecucion del metodo: " + identMetodo
					+ " en la clase: " + accionesSemAgteReactivo.getClass().getName());
			ite.printStackTrace();
	...
	@Override
	public synchronized void ejecutarMetodoThread(Class claseAccionEjecutar, String identMetodo,
			Object... paramsEjecucion) throws Exception {
		throw new ExcepcionEjecucionAcciones("GestorAccionesImp", "error al ejecutar un metodo"
				+ identMetodo + " de la clase: " + accionesSemAgteReactivo.getClass().getName(),
