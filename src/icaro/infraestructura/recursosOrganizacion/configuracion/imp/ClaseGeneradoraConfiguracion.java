 ...
 */
public abstract class ClaseGeneradoraConfiguracion extends ImplRecursoSimple implements
		ItfUsoConfiguracion {
	...
	public static ClaseGeneradoraConfiguracion instance() throws ExcepcionEnComponente,
			RemoteException {
		try {
			if (instance == null)
