...
public class FactoriaAutomatas extends FactoriaComponenteIcaro {
	...
	public synchronized InterpreteAutomataEFconGestAcciones crearInterpreteAutomataEFconGestorAcciones(
			String identPropietario, String rutaFicheroAutomata, String rutaCarpetaAcciones,
			Boolean trazar) {
		XMLParserTablaEstadosAutomataEFinputObj parser = new XMLParserTablaEstadosAutomataEFinputObj(
				identPropietario);
		TablaEstadosAutomataEFinputObjts tablaEF = parser.extraeTablaEstadosDesdeFicheroXML(
				rutaFicheroAutomata, rutaCarpetaAcciones);
	...
	public synchronized InterpreteAutomataEFconGestAcciones crearAutomataParaControlAgteReactivo(
		...
		TablaEstadosAutomataEFinputObjts tablaEF = prueba1.extraeTablaEstadosDesdeFicheroXML(
				rutaFicheroAutomata, rutaCarpetaAcciones);
	...
	public static void main(String args[]) {
		...
		interpretePrueba = FactoriaComponenteIcaro.instanceAtms()
				.crearAutomataParaControlAgteReactivo(identPropietario, rutaFicheroAutomata,
						rutaCarpetaAcciones, Boolean.TRUE);
