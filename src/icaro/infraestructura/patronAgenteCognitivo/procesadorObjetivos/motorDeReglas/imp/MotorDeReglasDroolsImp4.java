...
public class MotorDeReglasDroolsImp4 implements ItfMotorDeReglas,ItfConfigMotorDeReglas {

    private AgenteCognitivo agent;               //inicializada en el constructor
    private StatefulKnowledgeSession kSesion ;   //inicializada en el metodo compileRules
