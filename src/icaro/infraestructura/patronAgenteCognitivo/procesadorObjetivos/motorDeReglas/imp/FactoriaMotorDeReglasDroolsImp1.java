...
public class FactoriaMotorDeReglasDroolsImp1 extends FactoriaMotorDeReglas {
	...
	private ArrayList<String> ficheroReglasCompilados = new ArrayList<String>();
	private ArrayList<KnowledgeBuilder> KbuildersObtenidos = new ArrayList<KnowledgeBuilder>();
	...
	@Override
	public synchronized ItfMotorDeReglas crearMotorDeReglas(AgenteCognitivo agent,
	...
	public synchronized KnowledgeBuilder compilarReglas(String agentId, InputStream fichero,
		...
		// KnowledgeBuilderFactory.newKnowledgeBuilderConfiguration();
			try {
				...
				trazas.aceptaNuevaTraza(new InfoTraza(agentId,
						"Motor de Reglas Drools: ERROR al compilar las reglas. " + ficheroReglas,
						InfoTraza.NivelTraza.error));
				e.printStackTrace();
			}
			return null;
