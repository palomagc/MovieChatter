...
public class AccionesSemanticasGestorOrganizacion extends AccionesSemanticasAgenteReactivo {
	...
	public void configurarGestor() {
		try {
			...
			trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Configuracion del agente : "
	...
	public void crearGestores() {
		try {
			...
			trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Gestor de recursos creado.",
					InfoTraza.NivelTraza.debug));
			...
			trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Gestor de agentes creado.",
					InfoTraza.NivelTraza.debug));
	...
	public void arrancarGestorAgentes() {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Arrancando Gestor de Agentes.",
				InfoTraza.NivelTraza.debug));
		try {
			((ItfGestionAgenteReactivo) this.itfUsoRepositorio
					.obtenerInterfaz(NombresPredefinidos.ITF_GESTION
	...
	public void arrancarGestorRecursos() {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Arrancando Gestor de Recursos.",
				InfoTraza.NivelTraza.debug));
		try {
			((ItfGestionAgenteReactivo) this.itfUsoRepositorio
					.obtenerInterfaz(NombresPredefinidos.ITF_GESTION
	...
	public void gestoresArrancadosConExito() {
		...
		this.hebra.start();
		this.generarTimeOut(tiempoParaNuevaMonitorizacion, "monitorizar", nombreAgente,
				nombreAgente);
	...
	/**
	 * Decide que hacer en caso de fallos en el gestor de agentes y/o en el gestor de recursos
	 */
	...
	public void terminarGestorAgentes() {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Terminando gestor de agentes",
				InfoTraza.NivelTraza.debug));
		...
		try {
			...
			itfGestorAgentes.aceptaMensaje(new MensajeSimple(new InfoContEvtMsgAgteReactivo(
					"ordenTerminacion"), this.nombreAgente,
					NombresPredefinidos.NOMBRE_GESTOR_AGENTES));
	...
	public void terminarGestorRecursos() {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente, "Terminando gestor de recursos",
				InfoTraza.NivelTraza.debug));
		...
		try {
			...
			gestorRecursos.aceptaMensaje(new MensajeSimple(new InfoContEvtMsgAgteReactivo(
					"ordenTerminacion"), this.nombreAgente,
					NombresPredefinidos.NOMBRE_GESTOR_RECURSOS));
			// timeout de 5 segundosnew
	...
	public void recuperarErrorAlMonitorizarGestores() {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombreAgente,
				"No se pudo recuperar el error de monitorizacion.", InfoTraza.NivelTraza.debug));
		try {
			this.itfUsoPropiadeEsteAgente.aceptaEvento(new EventoRecAgte(
